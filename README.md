...
Python-разработчик. Строю Telegram-боты, изучаю ML и автоматизацию.  
Сейчас: Yandex.Practicum (Django) + КГТУ (КИС).
...
|--------|----------|------|
| [HabitTrackerBot](https://github.com/stonebridgeway/HabbitTrackerBot) | Telegram-бот для трекинга привычек с напоминаниями и аналитикой | aiogram · FastAPI · PostgreSQL · Redis · Celery |
